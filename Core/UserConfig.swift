...
class UserConfig {
    ...
    var sasayakiSeekControls: Bool {
        didSet { UserDefaults.standard.set(sasayakiSeekControls, forKey: "sasayakiSeekControls") }
    }
    ...
    init() {
        ...
        self.sasayakiSeekControls = defaults.object(forKey: "sasayakiSeekControls") as? Bool ?? false
